...
var G__20058 = cljs.core.first(element_str);
switch (G__20058) {
case "?":
arr.push((1));
...
var G__20060 = cljs.core.next(items);
items = G__20060;
continue;
} else {
return null;
...
var G__20061 = cljs.core.next(items);
items = G__20061;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__20064 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__20064) : is_valid_QMARK_.call(null,G__20064));
})())){
var G__20065 = cljs.core.next(cljs.core.next(items));
items = G__20065;
continue;
} else {
return true;
...
switch (G__20069) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__20069){
return (function (p1__20066_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20066_SHARP_,(2));
});})(G__20069))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20067_SHARP_,(1));
});})(G__20069))
))){
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20069)].join('')));
