...
var G__35196 = cljs.core.first.call(null,element_str);
switch (G__35196) {
case "?":
arr.push((1));
...
var G__35198 = cljs.core.next.call(null,items);
items = G__35198;
continue;
} else {
return null;
...
var G__35199 = cljs.core.next.call(null,items);
items = G__35199;
continue;
} else {
return null;
...
var G__35201 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__35201;
continue;
} else {
return true;
...
switch (G__35205) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__35205){
return (function (p1__35202_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35202_SHARP_,(2));
});})(G__35205))
))){
...
return cljs.core.not_EQ_.call(null,p1__35203_SHARP_,(1));
});})(G__35205))
))){
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35205)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1497481537735