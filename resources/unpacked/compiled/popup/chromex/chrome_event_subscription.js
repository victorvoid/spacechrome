...
var target_obj_37290 = self__.chrome_event;
var _STAR_runtime_state_STAR_37294 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_37290,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var call_info_37292 = [target_obj_37290,(function (){var next_obj_37293 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_37290,(0),"addListener",true))?(target_obj_37290["addListener"]):null);
return next_obj_37293;
})()];
var fn_37291 = (call_info_37292[(1)]);
if(oops.core.validate_fn_call_dynamically.call(null,fn_37291,oops.state.get_last_access_modifier.call(null))){
if(!((fn_37291 == null))){
return fn_37291.apply((call_info_37292[(0)]),oops.helpers.to_native_array.call(null,cljs.core.cons.call(null,self__.listener,extra_args)));
} else {
return null;
}
} else {
...
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_37294;
}}
});
...
var target_obj_37295_37301 = self__.chrome_event;
var _STAR_runtime_state_STAR_37299_37302 = oops.state._STAR_runtime_state_STAR_;
oops.state._STAR_runtime_state_STAR_ = oops.state.prepare_state.call(null,target_obj_37295_37301,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});

try{var call_info_37297_37303 = [target_obj_37295_37301,(function (){var next_obj_37298 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_37295_37301,(0),"removeListener",true))?(target_obj_37295_37301["removeListener"]):null);
return next_obj_37298;
})()];
var fn_37296_37304 = (call_info_37297_37303[(1)]);
if(oops.core.validate_fn_call_dynamically.call(null,fn_37296_37304,oops.state.get_last_access_modifier.call(null))){
if(!((fn_37296_37304 == null))){
fn_37296_37304.call((call_info_37297_37303[(0)]),self__.listener);
} else {
}
} else {
}
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR_37299_37302;
}
if(((!((self__.chan == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === self__.chan.chromex$protocols$IChromeEventChannel$)))?true:(((!self__.chan.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromeEventChannel,self__.chan):false)):cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromeEventChannel,self__.chan))){
...
//# sourceMappingURL=chrome_event_subscription.js.map?rel=1497481540484