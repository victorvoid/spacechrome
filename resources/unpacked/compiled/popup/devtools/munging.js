...
var o45447 = temp__5276__auto__;
var temp__5276__auto____$1 = (o45447["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o45448 = temp__5276__auto____$1;
return (o45448["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__45195__auto__ = f;
return (o__45195__auto__["toString"]).call(o__45195__auto__);
} else {
return "";
}
...
try{var o__45195__auto___45453 = t;
(o__45195__auto___45453["cljs$lang$ctorPrWriter"]).call(o__45195__auto___45453,t,writer);
}catch (e45452){var __45454 = e45452;
}
...
var char_code = (function (){var o__45195__auto__ = (new String(char$));
return (o__45195__auto__["charCodeAt"]).call(o__45195__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__45195__auto__ = String;
return (o__45195__auto__["fromCharCode"]).call(o__45195__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45456 = num_code;
switch (G__45456) {
case (1):
return (185);
...
var o__45195__auto__ = String;
return (o__45195__auto__["fromCharCode"]).call(o__45195__auto__,superscript_code);
});
/**
...
}catch (e45462){var _e__45202__auto__ = e45462;
return false;
}})())){
...
var vec__45463 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__45463,(0),null);
...
var or__28459__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
if(cljs.core.truth_(temp__5276__auto__)){
var o45468 = temp__5276__auto__;
var temp__5276__auto____$1 = (o45468["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o45469 = temp__5276__auto____$1;
return (o45469["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29680__auto___45476 = arguments.length;
var i__29681__auto___45477 = (0);
while(true){
if((i__29681__auto___45477 < len__29680__auto___45476)){
args__29687__auto__.push((arguments[i__29681__auto___45477]));

var G__45478 = (i__29681__auto___45477 + (1));
i__29681__auto___45477 = G__45478;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29688__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45472){
var vec__45473 = p__45472;
var ns_detector = cljs.core.nth.call(null,vec__45473,(0),null);
var effective_detector = (function (){var or__28459__auto__ = ns_detector;
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
var G__45479 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__45480 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__45479;
remaining_tokens = G__45480;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45470){
var G__45471 = cljs.core.first.call(null,seq45470);
var seq45470__$1 = cljs.core.next.call(null,seq45470);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__45471,seq45470__$1);
});
...
var vec__45488 = cljs.core.split_with.call(null,(function (p1__45484_SHARP_){
return cljs.core.not_EQ_.call(null,p1__45484_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__45488,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__45488,(1),null);
...
var vec__45494 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__45494,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__45494,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__45497 = cljs.core.rest.call(null,remaining_tokens);
var G__45498 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__45497;
name_tokens = G__45498;
continue;
} else {
...
var args45499 = [];
var len__29680__auto___45511 = arguments.length;
var i__29681__auto___45512 = (0);
while(true){
if((i__29681__auto___45512 < len__29680__auto___45511)){
args45499.push((arguments[i__29681__auto___45512]));

var G__45513 = (i__29681__auto___45512 + (1));
i__29681__auto___45512 = G__45513;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args45499.length)].join('')));
...
var vec__45502 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__45502,(0),null);
var arity = cljs.core.nth.call(null,vec__45502,(1),null);
var vec__45505 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__45505,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__45505,(1),null);
var vec__45508 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__45508,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__45508,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__45508,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__45508,(3),null);
...
var args45515 = [];
var len__29680__auto___45521 = arguments.length;
var i__29681__auto___45522 = (0);
while(true){
if((i__29681__auto___45522 < len__29680__auto___45521)){
args45515.push((arguments[i__29681__auto___45522]));

var G__45523 = (i__29681__auto___45522 + (1));
i__29681__auto___45522 = G__45523;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args45515.length)].join('')));
...
var vec__45518 = result;
var munged_ns = cljs.core.nth.call(null,vec__45518,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__45518,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__45518,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__45518,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__45518,(4),null);
var arity = cljs.core.nth.call(null,vec__45518,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__45531 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__45531,(0),null);
var args = cljs.core.nth.call(null,vec__45531,(1),null);
var vec__45534 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__45534,(0),null);
var name = cljs.core.nth.call(null,vec__45534,(1),null);
...
var G__45537 = (arity + (1));
var G__45538 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45539){
var vec__45543 = p__45539;
var arity = cljs.core.nth.call(null,vec__45543,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__45543,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28459__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__45546_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__45547_SHARP_);
...
var args__29687__auto__ = [];
var len__29680__auto___45554 = arguments.length;
var i__29681__auto___45555 = (0);
while(true){
if((i__29681__auto___45555 < len__29680__auto___45554)){
args__29687__auto__.push((arguments[i__29681__auto___45555]));

var G__45556 = (i__29681__auto___45555 + (1));
i__29681__auto___45555 = G__45556;
continue;
} else {
}
break;
...
var argseq__29688__auto__ = ((((1) < args__29687__auto__.length))?(new cljs.core.IndexedSeq(args__29687__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29688__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45550){
var vec__45551 = p__45550;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__45551,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45548){
var G__45549 = cljs.core.first.call(null,seq45548);
var seq45548__$1 = cljs.core.next.call(null,seq45548);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__45549,seq45548__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28459__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28447__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28459__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
var map__45565 = options;
var map__45565__$1 = ((((!((map__45565 == null)))?((((map__45565.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45565.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45565):map__45565);
var include_ns_QMARK_ = cljs.core.get.call(null,map__45565__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__45565__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__45565__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__45565__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45566 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__45566,(0),null);
var fn_name = cljs.core.nth.call(null,vec__45566,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__45566,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__45566,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__45566,(4),null);
var arity = cljs.core.nth.call(null,vec__45566,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28447__auto__ = protocol_ns;
if(cljs.core.truth_(and__28447__auto__)){
return cljs.core.not.call(null,(function (){var and__28447__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28459__auto__ = protocol_part;
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
return fn_part;
...
var o__45195__auto__ = f;
return (o__45195__auto__["getBasis"]).call(o__45195__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28447__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28447__auto__)){
...
}catch (e45571){var _e__45202__auto__ = e45571;
...
var G__45572 = (obj[cljs.core.first.call(null,path)]);
var G__45573 = cljs.core.rest.call(null,path);
obj = G__45572;
path = G__45573;
continue;
} else {
...
var partition_bits = (function (){var or__28459__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
return (0);
...
return (function (accum,p__45578){
var vec__45579 = p__45578;
var bit = cljs.core.nth.call(null,vec__45579,(0),null);
var protocol = cljs.core.nth.call(null,vec__45579,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__45582){
var vec__45586 = p__45582;
var ns = cljs.core.nth.call(null,vec__45586,(0),null);
var name = cljs.core.nth.call(null,vec__45586,(1),null);
var selector = cljs.core.nth.call(null,vec__45586,(2),null);
...
return (function (p__45594){
var vec__45595 = p__45594;
var munged_name = cljs.core.nth.call(null,vec__45595,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__45595,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__45595,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__45589_SHARP_){
return (obj[cljs.core.first.call(null,p1__45589_SHARP_)]);
});})(name,sorted_matches,vec__45595,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1497481549100