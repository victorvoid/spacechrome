...
}catch (e46405){var _e = e46405;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___46408 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___46408)){
var seen_errors_46409 = temp__5276__auto___46408;
if(cljs.core.truth_(seen_errors_46409.has(self))){
} else {
seen_errors_46409.add(self);

var temp__5278__auto___46410 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___46410)){
var sense_46411 = temp__5278__auto___46410;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46411)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1497481550613