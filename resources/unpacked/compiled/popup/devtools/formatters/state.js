...
var len__29680__auto___45634 = arguments.length;
var i__29681__auto___45635 = (0);
while(true){
if((i__29681__auto___45635 < len__29680__auto___45634)){
args__29687__auto__.push((arguments[i__29681__auto___45635]));

var G__45636 = (i__29681__auto___45635 + (1));
i__29681__auto___45635 = G__45636;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq45632){
var G__45633 = cljs.core.first.call(null,seq45632);
var seq45632__$1 = cljs.core.next.call(null,seq45632);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__45633,seq45632__$1);
});
...
return (p1__45637_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1497481549262