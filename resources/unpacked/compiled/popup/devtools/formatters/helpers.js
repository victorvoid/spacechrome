...
var G__45600 = devtools.prefs.pref.call(null,v);
v = G__45600;
continue;
} else {
return v;
...
}catch (e45613){var _e__45202__auto__ = e45613;
return false;
}})();
...
}catch (e45617){var _e__45202__auto__ = e45617;
return false;
}})();
...
}catch (e45619){var _e__45202__auto__ = e45619;
return false;
}}
}
});
...
var vec__45624 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__45624,(0),null);
var name = cljs.core.nth.call(null,vec__45624,(1),null);
...
return cljs.core.some.call(null,(function (p1__45627_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45627_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1497481549218