...
var len__29680__auto___45643 = arguments.length;
var i__29681__auto___45644 = (0);
while(true){
if((i__29681__auto___45644 < len__29680__auto___45643)){
args__29687__auto__.push((arguments[i__29681__auto___45644]));

var G__45645 = (i__29681__auto___45644 + (1));
i__29681__auto___45644 = G__45645;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29688__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45640){
var G__45641 = cljs.core.first.call(null,seq45640);
var seq45640__$1 = cljs.core.next.call(null,seq45640);
var G__45642 = cljs.core.first.call(null,seq45640__$1);
var seq45640__$2 = cljs.core.next.call(null,seq45640__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__45641,G__45642,seq45640__$2);
});
...
if(cljs.core.truth_((function (){var or__28459__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__29116__auto__,writer__29117__auto__,opt__29118__auto__){
return cljs.core._write.call(null,writer__29117__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__28447__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__28447__auto__){
var or__28459__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45646_SHARP_){
return !((cljs.core.meta.call(null,p1__45646_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__45655__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__28459__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e45659){var _e__45202__auto__ = e45659;
return false;
}})();
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
...
}catch (e45661){var _e__45202__auto__ = e45661;
return false;
}}
})())){
...
var _STAR_current_state_STAR_45666 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__45667 = opts;
var map__45667__$1 = ((((!((map__45667 == null)))?((((map__45667.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45667.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45667):map__45667);
var markup_db = cljs.core.get.call(null,map__45667__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_45666;
}});
...
;
var temp__5276__auto___45672 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___45672)){
var managed_print_level_45673 = temp__5276__auto___45672;
var _STAR_print_level_STAR_45671_45674 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_45673;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_45671_45674,managed_print_level_45673,temp__5276__auto___45672,writer,opts,job_fn){
return (function (p1__45669_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45669_SHARP_,null);
});})(_STAR_print_level_STAR_45671_45674,managed_print_level_45673,temp__5276__auto___45672,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_45671_45674;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1497481549382