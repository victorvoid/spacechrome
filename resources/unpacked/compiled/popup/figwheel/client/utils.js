...
return (new CustomEvent(event_name,(function (){var obj40656 = {"detail":data};
return obj40656;
})()));
} else {
...
var args40661 = [];
var len__29680__auto___40667 = arguments.length;
var i__29681__auto___40668 = (0);
while(true){
if((i__29681__auto___40668 < len__29680__auto___40667)){
args40661.push((arguments[i__29681__auto___40668]));

var G__40669 = (i__29681__auto___40668 + (1));
i__29681__auto___40668 = G__40669;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args40661.length)].join('')));
...
var f = (function (){var pred__40664 = cljs.core._EQ_;
var expr__40665 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40664.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40665))){
return ((function (pred__40664,expr__40665){
return (function (p1__40657_SHARP_){
return console.warn(p1__40657_SHARP_);
});
;})(pred__40664,expr__40665))
} else {
if(cljs.core.truth_(pred__40664.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40665))){
return ((function (pred__40664,expr__40665){
return (function (p1__40658_SHARP_){
return console.debug(p1__40658_SHARP_);
});
;})(pred__40664,expr__40665))
} else {
if(cljs.core.truth_(pred__40664.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40665))){
return ((function (pred__40664,expr__40665){
return (function (p1__40659_SHARP_){
return console.error(p1__40659_SHARP_);
});
;})(pred__40664,expr__40665))
} else {
return ((function (pred__40664,expr__40665){
return (function (p1__40660_SHARP_){
return console.log(p1__40660_SHARP_);
});
;})(pred__40664,expr__40665))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40671){
var map__40674 = p__40671;
...
var opts = map__40674__$1;
var eval_fn = cljs.core.get.call(null,map__40674__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__40676_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__40678,(0),null);
var v = cljs.core.nth.call(null,vec__40678,(1),null);
...
var args40681 = [];
var len__29680__auto___40684 = arguments.length;
var i__29681__auto___40685 = (0);
while(true){
if((i__29681__auto___40685 < len__29680__auto___40684)){
args40681.push((arguments[i__29681__auto___40685]));

var G__40686 = (i__29681__auto___40685 + (1));
i__29681__auto___40685 = G__40686;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args40681.length)].join('')));
...
//# sourceMappingURL=utils.js.map?rel=1497481544153