...
var or__28459__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj55777 = {"detail":data};
return obj55777;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28447__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28447__auto__)){
var and__28447__auto____$1 = (window["CustomEvent"]);
...
var args55782 = [];
var len__29680__auto___55788 = arguments.length;
var i__29681__auto___55789 = (0);
while(true){
if((i__29681__auto___55789 < len__29680__auto___55788)){
args55782.push((arguments[i__29681__auto___55789]));

var G__55790 = (i__29681__auto___55789 + (1));
i__29681__auto___55789 = G__55790;
continue;
} else {
}
break;
...
var f = (function (){var pred__55785 = cljs.core._EQ_;
var expr__55786 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__55785.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__55786))){
return ((function (pred__55785,expr__55786){
return (function (p1__55778_SHARP_){
return console.warn(p1__55778_SHARP_);
});
;})(pred__55785,expr__55786))
} else {
if(cljs.core.truth_(pred__55785.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__55786))){
return ((function (pred__55785,expr__55786){
return (function (p1__55779_SHARP_){
return console.debug(p1__55779_SHARP_);
});
;})(pred__55785,expr__55786))
} else {
if(cljs.core.truth_(pred__55785.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__55786))){
return ((function (pred__55785,expr__55786){
return (function (p1__55780_SHARP_){
return console.error(p1__55780_SHARP_);
});
;})(pred__55785,expr__55786))
} else {
return ((function (pred__55785,expr__55786){
return (function (p1__55781_SHARP_){
return console.log(p1__55781_SHARP_);
});
;})(pred__55785,expr__55786))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__55792){
var map__55795 = p__55792;
var map__55795__$1 = ((((!((map__55795 == null)))?((((map__55795.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55795.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55795):map__55795);
var opts = map__55795__$1;
var eval_fn = cljs.core.get.call(null,map__55795__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__55797_SHARP_);
});})(new_def))
);
...
return (function (p__55798){
var vec__55799 = p__55798;
var ky = cljs.core.nth.call(null,vec__55799,(0),null);
var v = cljs.core.nth.call(null,vec__55799,(1),null);
...
var args55802 = [];
var len__29680__auto___55805 = arguments.length;
var i__29681__auto___55806 = (0);
while(true){
if((i__29681__auto___55806 < len__29680__auto___55805)){
args55802.push((arguments[i__29681__auto___55806]));

var G__55807 = (i__29681__auto___55806 + (1));
i__29681__auto___55806 = G__55807;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args55802.length)].join('')));
...
if(cljs.core.truth_((function (){var and__28447__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1497481560143