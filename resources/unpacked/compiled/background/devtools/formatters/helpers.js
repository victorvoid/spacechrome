...
var G__60363 = devtools.prefs.pref.call(null,v);
v = G__60363;
continue;
} else {
return v;
...
var and__28447__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28447__auto__){
var and__28447__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28459__auto__ = (function (){try{if(!((value == null))){
...
}catch (e60376){var _e__45202__auto__ = e60376;
return false;
}})();
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
var or__28459__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e60380){var _e__45202__auto__ = e60380;
return false;
}})();
...
}catch (e60382){var _e__45202__auto__ = e60382;
return false;
}}
}
});
...
var and__28447__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28447__auto____$1){
...
var or__28459__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
var and__28447__auto__ = (function (){var or__28459__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
var vec__60387 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__60387,(0),null);
var name = cljs.core.nth.call(null,vec__60387,(1),null);
...
var and__28447__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28447__auto__)){
...
var or__28459__auto__ = typeof value === 'string';
if(or__28459__auto__){
return or__28459__auto__;
} else {
var or__28459__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__60390_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__60390_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1497481565117