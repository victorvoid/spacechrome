...
var len__29680__auto___60397 = arguments.length;
var i__29681__auto___60398 = (0);
while(true){
if((i__29681__auto___60398 < len__29680__auto___60397)){
args__29687__auto__.push((arguments[i__29681__auto___60398]));

var G__60399 = (i__29681__auto___60398 + (1));
i__29681__auto___60398 = G__60399;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29688__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq60395){
var G__60396 = cljs.core.first.call(null,seq60395);
var seq60395__$1 = cljs.core.next.call(null,seq60395);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__60396,seq60395__$1);
});
...
return (p1__60400_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1497481565150