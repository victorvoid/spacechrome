...
var and__28447__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__28447__auto__){
var or__28459__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e60828){var _e__45202__auto__ = e60828;
return false;
...
}catch (e60830){var _e__45202__auto__ = e60830;
return false;
...
}catch (e60836){var _e__45202__auto__ = e60836;
return false;
...
}catch (e60838){var _e__45202__auto__ = e60838;
return false;
...
}catch (e60844){var _e__45202__auto__ = e60844;
return false;
}})())){
...
}catch (e60846){var _e__45202__auto__ = e60846;
return false;
}})())){
...
var _STAR_current_state_STAR_60849 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__28459__auto__ = config;
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_60849;
}});
});
...
return (function() { 
var G__60852__delegate = function (args){
...
while (G__60853__i < G__60853__a.length) {G__60853__a[G__60853__i] = arguments[G__60853__i + 0]; ++G__60853__i;}
  args = new cljs.core.IndexedSeq(G__60853__a,0,null);
} 
return G__60852__delegate.call(this,args);};
G__60852.cljs$lang$maxFixedArity = 0;
G__60852.cljs$lang$applyTo = (function (arglist__60854){
var args = cljs.core.seq(arglist__60854);
return G__60852__delegate(args);
});
...
var pre_handler = (function (){var or__28459__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
...
var post_handler = (function (){var or__28459__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1497481565943