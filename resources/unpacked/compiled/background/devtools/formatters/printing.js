...
var len__29680__auto___60406 = arguments.length;
var i__29681__auto___60407 = (0);
while(true){
if((i__29681__auto___60407 < len__29680__auto___60406)){
args__29687__auto__.push((arguments[i__29681__auto___60407]));

var G__60408 = (i__29681__auto___60407 + (1));
i__29681__auto___60407 = G__60408;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq60403){
var G__60404 = cljs.core.first.call(null,seq60403);
var seq60403__$1 = cljs.core.next.call(null,seq60403);
var G__60405 = cljs.core.first.call(null,seq60403__$1);
var seq60403__$2 = cljs.core.next.call(null,seq60403__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__60404,G__60405,seq60403__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__60409_SHARP_){
return !((cljs.core.meta.call(null,p1__60409_SHARP_) == null));
})))){
...
var map__60418 = opts;
var map__60418__$1 = ((((!((map__60418 == null)))?((((map__60418.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60418.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60418):map__60418);
var markup_db = cljs.core.get.call(null,map__60418__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e60422){var _e__45202__auto__ = e60422;
return false;
}})();
if(cljs.core.truth_(or__28459__auto__)){
return or__28459__auto__;
...
}catch (e60424){var _e__45202__auto__ = e60424;
return false;
}}
})())){
...
var _STAR_current_state_STAR_60429 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__60430 = opts;
...
var markup_db = cljs.core.get.call(null,map__60430__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_60429;
}});
...
;
var temp__5276__auto___60435 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5276__auto___60435)){
var managed_print_level_60436 = temp__5276__auto___60435;
var _STAR_print_level_STAR_60434_60437 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_60436;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_60434_60437,managed_print_level_60436,temp__5276__auto___60435,writer,opts,job_fn){
return (function (p1__60432_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__60432_SHARP_,null);
});})(_STAR_print_level_STAR_60434_60437,managed_print_level_60436,temp__5276__auto___60435,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_60434_60437;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1497481565246