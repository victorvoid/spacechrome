...
var o60210 = temp__5276__auto__;
var temp__5276__auto____$1 = (o60210["core"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o60211 = temp__5276__auto____$1;
return (o60211["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__45195__auto___60216 = t;
(o__45195__auto___60216["cljs$lang$ctorPrWriter"]).call(o__45195__auto___60216,t,writer);
}catch (e60215){var __60217 = e60215;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__60219 = num_code;
switch (G__60219) {
case (1):
return (185);
...
}catch (e60225){var _e__45202__auto__ = e60225;
return false;
}})())){
...
var vec__60226 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__60226,(0),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var o60231 = temp__5276__auto__;
var temp__5276__auto____$1 = (o60231["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o60232 = temp__5276__auto____$1;
return (o60232["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29680__auto___60239 = arguments.length;
var i__29681__auto___60240 = (0);
while(true){
if((i__29681__auto___60240 < len__29680__auto___60239)){
args__29687__auto__.push((arguments[i__29681__auto___60240]));

var G__60241 = (i__29681__auto___60240 + (1));
i__29681__auto___60240 = G__60241;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__60235){
var vec__60236 = p__60235;
var ns_detector = cljs.core.nth.call(null,vec__60236,(0),null);
...
var G__60242 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__60243 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__60242;
remaining_tokens = G__60243;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq60233){
var G__60234 = cljs.core.first.call(null,seq60233);
var seq60233__$1 = cljs.core.next.call(null,seq60233);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__60234,seq60233__$1);
});
...
var vec__60251 = cljs.core.split_with.call(null,(function (p1__60247_SHARP_){
return cljs.core.not_EQ_.call(null,p1__60247_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__60251,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__60251,(1),null);
...
var vec__60257 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__60257,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__60257,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__60260 = cljs.core.rest.call(null,remaining_tokens);
var G__60261 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__60260;
name_tokens = G__60261;
continue;
} else {
...
var args60262 = [];
var len__29680__auto___60274 = arguments.length;
var i__29681__auto___60275 = (0);
while(true){
if((i__29681__auto___60275 < len__29680__auto___60274)){
args60262.push((arguments[i__29681__auto___60275]));

var G__60276 = (i__29681__auto___60275 + (1));
i__29681__auto___60275 = G__60276;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args60262.length)].join('')));
...
var vec__60265 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__60265,(0),null);
var arity = cljs.core.nth.call(null,vec__60265,(1),null);
var vec__60268 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__60268,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__60268,(1),null);
var vec__60271 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__60271,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__60271,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__60271,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__60271,(3),null);
...
var args60278 = [];
var len__29680__auto___60284 = arguments.length;
var i__29681__auto___60285 = (0);
while(true){
if((i__29681__auto___60285 < len__29680__auto___60284)){
args60278.push((arguments[i__29681__auto___60285]));

var G__60286 = (i__29681__auto___60285 + (1));
i__29681__auto___60285 = G__60286;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args60278.length)].join('')));
...
var vec__60281 = result;
var munged_ns = cljs.core.nth.call(null,vec__60281,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__60281,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__60281,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__60281,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__60281,(4),null);
var arity = cljs.core.nth.call(null,vec__60281,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__60294 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__60294,(0),null);
var args = cljs.core.nth.call(null,vec__60294,(1),null);
var vec__60297 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__60297,(0),null);
var name = cljs.core.nth.call(null,vec__60297,(1),null);
...
var G__60300 = (arity + (1));
var G__60301 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__60302){
var vec__60306 = p__60302;
var arity = cljs.core.nth.call(null,vec__60306,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__60306,(1),null);
...
return (function (p1__60309_SHARP_){
return cljs.core.get.call(null,arities,p1__60309_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__60310_SHARP_);
...
var args__29687__auto__ = [];
var len__29680__auto___60317 = arguments.length;
var i__29681__auto___60318 = (0);
while(true){
if((i__29681__auto___60318 < len__29680__auto___60317)){
args__29687__auto__.push((arguments[i__29681__auto___60318]));

var G__60319 = (i__29681__auto___60318 + (1));
i__29681__auto___60318 = G__60319;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__60313){
var vec__60314 = p__60313;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__60314,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq60311){
var G__60312 = cljs.core.first.call(null,seq60311);
var seq60311__$1 = cljs.core.next.call(null,seq60311);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__60312,seq60311__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__60328__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__60328__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__60328__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__60328__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__60329 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__60329,(0),null);
var fn_name = cljs.core.nth.call(null,vec__60329,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__60329,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__60329,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__60329,(4),null);
var arity = cljs.core.nth.call(null,vec__60329,(5),null);
...
}catch (e60334){var _e__45202__auto__ = e60334;
...
var G__60335 = (obj[cljs.core.first.call(null,path)]);
var G__60336 = cljs.core.rest.call(null,path);
obj = G__60335;
path = G__60336;
continue;
} else {
...
return (function (accum,p__60341){
var vec__60342 = p__60341;
var bit = cljs.core.nth.call(null,vec__60342,(0),null);
var protocol = cljs.core.nth.call(null,vec__60342,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__60345){
var vec__60349 = p__60345;
var ns = cljs.core.nth.call(null,vec__60349,(0),null);
var name = cljs.core.nth.call(null,vec__60349,(1),null);
var selector = cljs.core.nth.call(null,vec__60349,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__60358,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__60358,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__60358,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__60352_SHARP_){
return (obj[cljs.core.first.call(null,p1__60352_SHARP_)]);
});})(name,sorted_matches,vec__60358,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1497481565024