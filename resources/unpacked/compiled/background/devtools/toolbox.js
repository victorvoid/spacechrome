...
var args60857 = [];
var len__29680__auto___60863 = arguments.length;
var i__29681__auto___60864 = (0);
while(true){
if((i__29681__auto___60864 < len__29680__auto___60863)){
args60857.push((arguments[i__29681__auto___60864]));

var G__60865 = (i__29681__auto___60864 + (1));
i__29681__auto___60864 = G__60865;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args60857.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox60860 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox60860 = (function (obj,header,style,tag,meta60861){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox60860.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60862,meta60861__$1){
var self__ = this;
var _60862__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox60860(self__.obj,self__.header,self__.style,self__.tag,meta60861__$1));
});

devtools.toolbox.t_devtools$toolbox60860.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60862){
var self__ = this;
var _60862__$1 = this;
return self__.meta60861;
});

devtools.toolbox.t_devtools$toolbox60860.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox60860.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox60860.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox60860.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox60860.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta60861","meta60861",-495487796,null)], null);
});

devtools.toolbox.t_devtools$toolbox60860.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox60860.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox60860";

devtools.toolbox.t_devtools$toolbox60860.cljs$lang$ctorPrWriter = (function (this__29116__auto__,writer__29117__auto__,opt__29118__auto__){
return cljs.core._write.call(null,writer__29117__auto__,"devtools.toolbox/t_devtools$toolbox60860");
});

devtools.toolbox.__GT_t_devtools$toolbox60860 = (function devtools$toolbox$__GT_t_devtools$toolbox60860(obj__$1,header__$1,style__$1,tag__$1,meta60861){
return (new devtools.toolbox.t_devtools$toolbox60860(obj__$1,header__$1,style__$1,tag__$1,meta60861));
});

}

return (new devtools.toolbox.t_devtools$toolbox60860(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1497481565978