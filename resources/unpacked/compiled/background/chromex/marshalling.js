...
if(((!((chrome_port == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === chrome_port.chromex$protocols$IChromePort$)))?true:(((!chrome_port.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromePort,chrome_port):false)):cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromePort,chrome_port))){
} else {
...
if(((!((chrome_storage_area == null)))?(((false) || ((cljs.core.PROTOCOL_SENTINEL === chrome_storage_area.chromex$protocols$IChromeStorageArea$)))?true:(((!chrome_storage_area.cljs$lang$protocol_mask$partition$))?cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromeStorageArea,chrome_storage_area):false)):cljs.core.native_satisfies_QMARK_.call(null,chromex.protocols.IChromeStorageArea,chrome_storage_area))){
} else {
...
//# sourceMappingURL=marshalling.js.map?rel=1497481555571